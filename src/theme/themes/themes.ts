...
export default [
  ...
  },
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(53, 132, 228)",
        "c-primary-dark-100": "rgb(48,119,205)",
        "c-primary-dark-100-alpha-100": "rgba(48, 119, 205, 0.90)",
        "c-primary-alpha-100": "rgba(53, 132, 228, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(48, 119, 205, 0.80)",
        "c-primary-alpha-200": "rgba(53, 132, 228, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(48, 119, 205, 0.70)",
        "c-primary-alpha-300": "rgba(53, 132, 228, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(48, 119, 205, 0.60)",
        "c-primary-alpha-400": "rgba(53, 132, 228, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(48, 119, 205, 0.50)",
        "c-primary-alpha-500": "rgba(53, 132, 228, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(48, 119, 205, 0.40)",
        "c-primary-alpha-600": "rgba(53, 132, 228, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(48, 119, 205, 0.30)",
        "c-primary-alpha-700": "rgba(53, 132, 228, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(48, 119, 205, 0.20)",
        "c-primary-alpha-800": "rgba(53, 132, 228, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(48, 119, 205, 0.10)",
        "c-primary-alpha-900": "rgba(53, 132, 228, 0.10)",
        "c-primary-dark-200": "rgb(43,107,185)",
        "c-primary-dark-200-alpha-100": "rgba(43, 107, 185, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(43, 107, 185, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(43, 107, 185, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(43, 107, 185, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(43, 107, 185, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(43, 107, 185, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(43, 107, 185, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(43, 107, 185, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(43, 107, 185, 0.10)",
        "c-primary-dark-300": "rgb(39,96,167)",
        "c-primary-dark-300-alpha-100": "rgba(39, 96, 167, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(39, 96, 167, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(39, 96, 167, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(39, 96, 167, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(39, 96, 167, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(39, 96, 167, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(39, 96, 167, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(39, 96, 167, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(39, 96, 167, 0.10)",
        "c-primary-dark-400": "rgb(35,86,150)",
        "c-primary-dark-400-alpha-100": "rgba(35, 86, 150, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(35, 86, 150, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(35, 86, 150, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(35, 86, 150, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(35, 86, 150, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(35, 86, 150, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(35, 86, 150, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(35, 86, 150, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(35, 86, 150, 0.10)",
        "c-primary-dark-500": "rgb(32,77,135)",
        "c-primary-dark-500-alpha-100": "rgba(32, 77, 135, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(32, 77, 135, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(32, 77, 135, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(32, 77, 135, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(32, 77, 135, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(32, 77, 135, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(32, 77, 135, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(32, 77, 135, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(32, 77, 135, 0.10)",
        "c-primary-dark-600": "rgb(29,69,122)",
        "c-primary-dark-600-alpha-100": "rgba(29, 69, 122, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(29, 69, 122, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(29, 69, 122, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(29, 69, 122, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(29, 69, 122, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(29, 69, 122, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(29, 69, 122, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(29, 69, 122, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(29, 69, 122, 0.10)",
        "c-primary-dark-700": "rgb(26,62,110)",
        "c-primary-dark-700-alpha-100": "rgba(26, 62, 110, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(26, 62, 110, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(26, 62, 110, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(26, 62, 110, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(26, 62, 110, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(26, 62, 110, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(26, 62, 110, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(26, 62, 110, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(26, 62, 110, 0.10)",
        "c-primary-dark-800": "rgb(23,56,99)",
        "c-primary-dark-800-alpha-100": "rgba(23, 56, 99, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(23, 56, 99, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(23, 56, 99, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(23, 56, 99, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(23, 56, 99, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(23, 56, 99, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(23, 56, 99, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(23, 56, 99, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(23, 56, 99, 0.10)",
        "c-primary-dark-900": "rgb(21,50,89)",
        "c-primary-dark-900-alpha-100": "rgba(21, 50, 89, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(21, 50, 89, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(21, 50, 89, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(21, 50, 89, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(21, 50, 89, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(21, 50, 89, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(21, 50, 89, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(21, 50, 89, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(21, 50, 89, 0.10)",
        "c-primary-dark-1000": "rgb(19,45,80)",
        "c-primary-dark-1000-alpha-100": "rgba(19, 45, 80, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(19, 45, 80, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(19, 45, 80, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(19, 45, 80, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(19, 45, 80, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(19, 45, 80, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(19, 45, 80, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(19, 45, 80, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(19, 45, 80, 0.10)",
        "c-primary-light-100": "rgb(93,157,233)",
        "c-primary-light-100-alpha-100": "rgba(93, 157, 233, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(93, 157, 233, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(93, 157, 233, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(93, 157, 233, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(93, 157, 233, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(93, 157, 233, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(93, 157, 233, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(93, 157, 233, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(93, 157, 233, 0.10)",
        "c-primary-light-200": "rgb(125,177,237)",
        "c-primary-light-200-alpha-100": "rgba(125, 177, 237, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(125, 177, 237, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(125, 177, 237, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(125, 177, 237, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(125, 177, 237, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(125, 177, 237, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(125, 177, 237, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(125, 177, 237, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(125, 177, 237, 0.10)",
        "c-primary-light-300": "rgb(151,193,241)",
        "c-primary-light-300-alpha-100": "rgba(151, 193, 241, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(151, 193, 241, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(151, 193, 241, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(151, 193, 241, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(151, 193, 241, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(151, 193, 241, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(151, 193, 241, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(151, 193, 241, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(151, 193, 241, 0.10)",
        "c-primary-light-400": "rgb(172,205,244)",
        "c-primary-light-400-alpha-100": "rgba(172, 205, 244, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(172, 205, 244, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(172, 205, 244, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(172, 205, 244, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(172, 205, 244, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(172, 205, 244, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(172, 205, 244, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(172, 205, 244, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(172, 205, 244, 0.10)",
        "c-primary-light-500": "rgb(189,215,246)",
        "c-primary-light-500-alpha-100": "rgba(189, 215, 246, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(189, 215, 246, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(189, 215, 246, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(189, 215, 246, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(189, 215, 246, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(189, 215, 246, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(189, 215, 246, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(189, 215, 246, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(189, 215, 246, 0.10)",
        "c-primary-light-600": "rgb(202,223,248)",
        "c-primary-light-600-alpha-100": "rgba(202, 223, 248, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(202, 223, 248, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(202, 223, 248, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(202, 223, 248, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(202, 223, 248, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(202, 223, 248, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(202, 223, 248, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(202, 223, 248, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(202, 223, 248, 0.10)",
        "c-primary-light-700": "rgb(213,229,249)",
        "c-primary-light-700-alpha-100": "rgba(213, 229, 249, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(213, 229, 249, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(213, 229, 249, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(213, 229, 249, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(213, 229, 249, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(213, 229, 249, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(213, 229, 249, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(213, 229, 249, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(213, 229, 249, 0.10)",
        "c-primary-light-800": "rgb(221,234,250)",
        "c-primary-light-800-alpha-100": "rgba(221, 234, 250, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(221, 234, 250, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(221, 234, 250, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(221, 234, 250, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(221, 234, 250, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(221, 234, 250, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(221, 234, 250, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(221, 234, 250, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(221, 234, 250, 0.10)",
        "c-primary-light-900": "rgb(228,238,251)",
        "c-primary-light-900-alpha-100": "rgba(228, 238, 251, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(228, 238, 251, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(228, 238, 251, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(228, 238, 251, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(228, 238, 251, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(228, 238, 251, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(228, 238, 251, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(228, 238, 251, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(228, 238, 251, 0.10)",
        "c-primary-light-1000": "rgb(255,255,255)",
        "c-primary-light-1000-alpha-100": "rgba(255, 255, 255, 0.90)",
        "c-primary-light-1000-alpha-200": "rgba(255, 255, 255, 0.80)",
        "c-primary-light-1000-alpha-300": "rgba(255, 255, 255, 0.70)",
  ...
  },
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(53, 132, 228)",
        "c-primary-dark-100": "rgb(93,157,233)",
        "c-primary-dark-100-alpha-100": "rgba(93, 157, 233, 0.90)",
        "c-primary-alpha-100": "rgba(53, 132, 228, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(93, 157, 233, 0.80)",
        "c-primary-alpha-200": "rgba(53, 132, 228, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(93, 157, 233, 0.70)",
        "c-primary-alpha-300": "rgba(53, 132, 228, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(93, 157, 233, 0.60)",
        "c-primary-alpha-400": "rgba(53, 132, 228, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(93, 157, 233, 0.50)",
        "c-primary-alpha-500": "rgba(53, 132, 228, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(93, 157, 233, 0.40)",
        "c-primary-alpha-600": "rgba(53, 132, 228, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(93, 157, 233, 0.30)",
        "c-primary-alpha-700": "rgba(53, 132, 228, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(93, 157, 233, 0.20)",
        "c-primary-alpha-800": "rgba(53, 132, 228, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(93, 157, 233, 0.10)",
        "c-primary-alpha-900": "rgba(53, 132, 228, 0.10)",
        "c-primary-dark-200": "rgb(125,177,237)",
        "c-primary-dark-200-alpha-100": "rgba(125, 177, 237, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(125, 177, 237, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(125, 177, 237, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(125, 177, 237, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(125, 177, 237, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(125, 177, 237, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(125, 177, 237, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(125, 177, 237, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(125, 177, 237, 0.10)",
        "c-primary-dark-300": "rgb(151,193,241)",
        "c-primary-dark-300-alpha-100": "rgba(151, 193, 241, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(151, 193, 241, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(151, 193, 241, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(151, 193, 241, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(151, 193, 241, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(151, 193, 241, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(151, 193, 241, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(151, 193, 241, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(151, 193, 241, 0.10)",
        "c-primary-dark-400": "rgb(172,205,244)",
        "c-primary-dark-400-alpha-100": "rgba(172, 205, 244, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(172, 205, 244, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(172, 205, 244, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(172, 205, 244, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(172, 205, 244, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(172, 205, 244, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(172, 205, 244, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(172, 205, 244, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(172, 205, 244, 0.10)",
        "c-primary-dark-500": "rgb(189,215,246)",
        "c-primary-dark-500-alpha-100": "rgba(189, 215, 246, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(189, 215, 246, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(189, 215, 246, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(189, 215, 246, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(189, 215, 246, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(189, 215, 246, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(189, 215, 246, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(189, 215, 246, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(189, 215, 246, 0.10)",
        "c-primary-dark-600": "rgb(202,223,248)",
        "c-primary-dark-600-alpha-100": "rgba(202, 223, 248, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(202, 223, 248, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(202, 223, 248, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(202, 223, 248, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(202, 223, 248, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(202, 223, 248, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(202, 223, 248, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(202, 223, 248, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(202, 223, 248, 0.10)",
        "c-primary-dark-700": "rgb(213,229,249)",
        "c-primary-dark-700-alpha-100": "rgba(213, 229, 249, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(213, 229, 249, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(213, 229, 249, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(213, 229, 249, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(213, 229, 249, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(213, 229, 249, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(213, 229, 249, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(213, 229, 249, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(213, 229, 249, 0.10)",
        "c-primary-dark-800": "rgb(221,234,250)",
        "c-primary-dark-800-alpha-100": "rgba(221, 234, 250, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(221, 234, 250, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(221, 234, 250, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(221, 234, 250, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(221, 234, 250, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(221, 234, 250, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(221, 234, 250, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(221, 234, 250, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(221, 234, 250, 0.10)",
        "c-primary-dark-900": "rgb(228,238,251)",
        "c-primary-dark-900-alpha-100": "rgba(228, 238, 251, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(228, 238, 251, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(228, 238, 251, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(228, 238, 251, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(228, 238, 251, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(228, 238, 251, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(228, 238, 251, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(228, 238, 251, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(228, 238, 251, 0.10)",
        "c-primary-dark-1000": "rgb(233,241,252)",
        "c-primary-dark-1000-alpha-100": "rgba(233, 241, 252, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(233, 241, 252, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(233, 241, 252, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(233, 241, 252, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(233, 241, 252, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(233, 241, 252, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(233, 241, 252, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(233, 241, 252, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(233, 241, 252, 0.10)",
        "c-primary-light-100": "rgb(48,119,205)",
        "c-primary-light-100-alpha-100": "rgba(48, 119, 205, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(48, 119, 205, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(48, 119, 205, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(48, 119, 205, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(48, 119, 205, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(48, 119, 205, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(48, 119, 205, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(48, 119, 205, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(48, 119, 205, 0.10)",
        "c-primary-light-200": "rgb(43,107,185)",
        "c-primary-light-200-alpha-100": "rgba(43, 107, 185, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(43, 107, 185, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(43, 107, 185, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(43, 107, 185, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(43, 107, 185, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(43, 107, 185, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(43, 107, 185, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(43, 107, 185, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(43, 107, 185, 0.10)",
        "c-primary-light-300": "rgb(39,96,167)",
        "c-primary-light-300-alpha-100": "rgba(39, 96, 167, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(39, 96, 167, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(39, 96, 167, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(39, 96, 167, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(39, 96, 167, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(39, 96, 167, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(39, 96, 167, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(39, 96, 167, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(39, 96, 167, 0.10)",
        "c-primary-light-400": "rgb(35,86,150)",
        "c-primary-light-400-alpha-100": "rgba(35, 86, 150, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(35, 86, 150, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(35, 86, 150, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(35, 86, 150, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(35, 86, 150, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(35, 86, 150, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(35, 86, 150, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(35, 86, 150, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(35, 86, 150, 0.10)",
        "c-primary-light-500": "rgb(32,77,135)",
        "c-primary-light-500-alpha-100": "rgba(32, 77, 135, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(32, 77, 135, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(32, 77, 135, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(32, 77, 135, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(32, 77, 135, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(32, 77, 135, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(32, 77, 135, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(32, 77, 135, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(32, 77, 135, 0.10)",
        "c-primary-light-600": "rgb(29,69,122)",
        "c-primary-light-600-alpha-100": "rgba(29, 69, 122, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(29, 69, 122, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(29, 69, 122, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(29, 69, 122, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(29, 69, 122, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(29, 69, 122, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(29, 69, 122, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(29, 69, 122, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(29, 69, 122, 0.10)",
        "c-primary-light-700": "rgb(26,62,110)",
        "c-primary-light-700-alpha-100": "rgba(26, 62, 110, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(26, 62, 110, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(26, 62, 110, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(26, 62, 110, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(26, 62, 110, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(26, 62, 110, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(26, 62, 110, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(26, 62, 110, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(26, 62, 110, 0.10)",
        "c-primary-light-800": "rgb(23,56,99)",
        "c-primary-light-800-alpha-100": "rgba(23, 56, 99, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(23, 56, 99, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(23, 56, 99, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(23, 56, 99, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(23, 56, 99, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(23, 56, 99, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(23, 56, 99, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(23, 56, 99, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(23, 56, 99, 0.10)",
        "c-primary-light-900": "rgb(21,50,89)",
        "c-primary-light-900-alpha-100": "rgba(21, 50, 89, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(21, 50, 89, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(21, 50, 89, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(21, 50, 89, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(21, 50, 89, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(21, 50, 89, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(21, 50, 89, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(21, 50, 89, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(21, 50, 89, 0.10)",
        "c-primary-light-1000": "rgb(14,33,58)",
        "c-primary-light-1000-alpha-100": "rgba(14, 33, 58, 0.90)",
        "c-primary-light-1000-alpha-200": "rgba(14, 33, 58, 0.80)",
        "c-primary-light-1000-alpha-300": "rgba(14, 33, 58, 0.70)",
        "c-primary-light-1000-alpha-400": "rgba(14, 33, 58, 0.60)",
        "c-primary-light-1000-alpha-500": "rgba(14, 33, 58, 0.50)",
        "c-primary-light-1000-alpha-600": "rgba(14, 33, 58, 0.40)",
        "c-primary-light-1000-alpha-700": "rgba(14, 33, 58, 0.30)",
        "c-primary-light-1000-alpha-800": "rgba(14, 33, 58, 0.20)",
        "c-primary-light-1000-alpha-900": "rgba(14, 33, 58, 0.10)",
        "c-theme": "rgb(21,50,89)",
